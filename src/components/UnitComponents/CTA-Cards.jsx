    ...
    <div className="border-b-2 py-7 px-4">
      <div className="w-full py-3.5 flex justify-around gap-11 mb-10">
        <ProductCard
          ...
          title="Buy Branded Purses"
        />
        <ProductCard
          imageUrl={sunGlasses}
          imageAlt="Men sunglasses"
          title="Buy Men's Glasses"
        />
        <ProductCard
          imageUrl={highHeelShoes}
          imageAlt="high heel shoes"
      ...
      <div className="w-full py-3.5 flex justify-around gap-2">
        ...
        <ServiceIcon
          ...
          subTitle={"Hourse: 8AM - 11PM"}
        />
        <ServiceIcon
          imageUrl={movingTruckIcon}
          imageAlt={"moving truck icon"}
          title={"Free World Shipping"}
          subTitle={"Orders Over $100"}
        />
        <ServiceIcon
          imageUrl={rocketShipIcon}
          imageAlt={"rocket ship icon"}
          title={"WIN $100 SHOP"}
          subTitle={"Enter Now!"}
        />
      </div>
