    ...
    return (
        <div className="top-header border-b-2 flex justify-around items-center py-5">
            ...
            <ul className="top-right inline-flex">
                ...
                <li><a onClick={toggleDropDownMenu} className="hover:text-slate-900 text-slate-600 flex px-9 border-l-2 ml-4 border-r-2 mr-4" href="#">My Account
                <img className="w-4 h-4 mt-1" src={downArrow} alt="arrow pointing down" />
                </a></li>
                <li><a className="hover:text-slate-900 text-slate-600" href="#">My Cart (0)
                    <div id="DropDownMenu" className="hidden absolute top-20 right-80 py-5 z-10 bg-slate-50 border-2 transition-all ease-in">
